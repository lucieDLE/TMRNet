...
root_dir2 = '/CMF/data/lumargot/cholec80/'
...
## to not take hidden files generated by mac
...
all_info_all2 = []
print()
print(len(img_dir_names2), len(phase_file_names2))
print()
for j in range(len(img_dir_names2)):
    downsample_rate = 25
